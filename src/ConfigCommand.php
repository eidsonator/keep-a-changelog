...
EOH;
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $question = new Question('Please enter the enterprise url for a local github/gitlab installation (Empty to skip)', '');
        $enterpriseUrl = $helper->ask($input, $output, $question);

        $config = new Config($token, $provider, $enterpriseUrl);
